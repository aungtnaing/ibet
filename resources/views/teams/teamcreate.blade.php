...
<div id="content">
	...
	<div class="container-fluid">
       ...
       <label>Team Name :</label>
            ...
            <input type="text" class="form-control" id="" name="name" placeholder="Enter team name" value="{{ old('name') }}" required>
            </div>
        
         <div class="form-group">
            <label>Myanmar Name :</label>

            <input type="text" class="form-control" name="mname" placeholder="Enter team myanmar name">
          ...
          <textarea name="about" placeholder="Enter team abouts" class="form-control" rows="2"></textarea>
