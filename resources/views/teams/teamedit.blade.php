...
<div id="content">
	...
	<div class="container-fluid">
								...
								<ul class="thumbnails">
									<li class="span3"> <a> 
										...
										<label for="file-input1">
											<i class="icon-camera"></i>.Main 150x150<br>
											@if($team->photourl1!="")
											<img id="blah" src= "{{ $team->photourl1 }}" width="100" height="100">
											@else
									...
									<li class="span3"> <a> 
										...
										<label for="file-input2">
											<i class="icon-camera"></i>.Thum 32x32<br>
											@if($team->photourl2!="")
											<img id="blah1" src= "{{ $team->photourl2 }}" width="100" height="100">
											@else
       ...
       <label>Team Name :</label>
            ...
            <input type="text" class="form-control" id="" name="name" placeholder="Enter team name" value="{{ $team->name }}" required>
            </div>
        
         <div class="form-group">
            <label>Myanmar Name :</label>

            <input type="text" value="{{ $team->mname }}"class="form-control" name="mname" placeholder="Enter team myanmar name">
          ...
          <textarea name="about" placeholder="Enter team abouts" class="form-control" rows="2">{{ $team->about }}"</textarea>
